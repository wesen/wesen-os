...
replace github.com/go-go-golems/go-go-app-inventory => ./workspace-links/go-go-app-inventory

replace github.com/go-go-golems/go-go-gepa => ./workspace-links/go-go-gepa
